...
#+end_export
The biggest effect on the jaggedness of the curves was dropout. Next time I will implement early stopping so the trials can terminate in fewer epochs and not overfit the models.
