...
for i in range(nsamples):
    ...
    fname_out = os.path.join(PROD, f"MC4R_relaxed_{i+1}.pdb")
...
fname_metadata = os.path.join(PROD, "relax_metadata.tsv")
...
print("\nCompleted all relaxations. Metadata saved to:", fname_metadata)
